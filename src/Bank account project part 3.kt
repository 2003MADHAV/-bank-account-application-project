fun main() {
    ...
    fun transfer(mode: String){
        ...
        while (isSystemOpen){
            ...
            option = (1..5).random() // Randomly generate a user input
            println("User selected option: $option")
            when(option){
                ...
                4 -> {
                    isSystemOpen = false
                    println("Closing the banking app.")
                }
                else -> {
